...
class ExportPdfReport 
{
    ...
    public function jsonToHtml_Service($data, $filter)
    {
        ...
        <tr style="background-color:#524F4F;color:#ffffff;">
          ...
          <td width="60"><b>Host State</b></td>
          <td width="560" align="center"><b>Service Output</b></td>
        ...
        for($i = 0; $i < sizeof($data); $i++)
        {
            ...
            if ($data[$i]['host_state'] == "0"){
                $host_state = "UP";
                $style_host = '<td width="60" class="host_up">';
            } elseif ($data[$i]['host_state'] == "1") {
                $host_state = "DOWN";
                $style_host = '<td width="60" class="host_down">';
            };
            ...
            $temp .= $style_host . $host_state . '</td>';
            $temp .= '<td width="560">' . $service_output . '</td>';
